                            ...
                            @foreach (config('translatable.locales') as $locale)
                                ...
                                <div class="mb-3 col-md-6">
                                    <label class="form-label"
                                           for="name[{{ $locale }}]">@lang('words.product_name') {{ trans('words.' . $locale )}}</label>
                            ...
                            @foreach (config('translatable.locales') as $key=>$locale)
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="content[{{ $locale }}]" class="form-label"
                                           for="">@lang('words.description') {{ trans('words.' . $locale )}}</label>
                                    <textarea required type="text" class=" form-control"
                                              name="content[{{ $locale }}]"


                                              placeholder="{{trans('words.description')}} {{ trans('words.' . $locale )}}"></textarea>
